      ...
      <div className="w-full max-w-sm animate-fade-in-scale">
        <div className="rounded-md border border-border bg-card px-8 py-9">
          ...
          <div className="mb-7 text-center">
            <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-md bg-foreground">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" aria-hidden="true">
                <path d="M2.5 6.5l7.5 5 7.5-5" style={{ stroke: "var(--background)" }} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                <rect x="1" y="4" width="18" height="12" rx="2" style={{ stroke: "var(--background)" }} strokeWidth="1.5"/>
              </svg>
            </div>
          ...
          <div className="mt-6 flex flex-col items-center gap-2 text-sm text-muted-foreground">
            <Link
              href="/auth/sign-in"
              className="flex items-center gap-1.5 font-medium text-foreground underline decoration-border underline-offset-4 hover:decoration-foreground"
            >
