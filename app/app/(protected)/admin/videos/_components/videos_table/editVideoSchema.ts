// app/admin/videos/_components/videos_table/editVideoSchema.ts
import * as z from "zod"

// Mirrors uploadForm/formSchema.ts's field rules — an edited video should
// still meet the same quality bar as a newly created one.
